...
$LNG['visited'] = 'Saya sedang mendaki:  <strong>%s</strong>';
$LNG['camp'] = '<strong>URGENT !!!</strong> Saya sedang membutuhkan: <strong>%s</strong>';
...
$LNG['form_title'] = 'Sharing Pengalaman & Kebutuhan HIKING anda';
...
$LNG['label_camp'] = 'Tambahkan kebutuhan Hiking yang anda perlukan';
/*$LNG['label_movie'] = 'Tambahkan film yang ditonton';*/
$LNG['label_visited'] = 'Tambahkan tempat Hiking yang dikunjungi';
